  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: "wheelchair_accessible", field_type: "boolean",
        ...
        required: false, position: 3,
        osm_keys: [ "wheelchair" ],
        osm_value_map: { "yes" => true, "no" => false, "designated" => true },
        osm_transform: "boolean" },
  ...
  },
  {
    ...
    fields: [
      ...
      { field_key: "is_free", field_type: "boolean",
        ...
        required: true, position: 2,
        osm_keys: [ "fee" ],
        osm_value_map: { "no" => true, "yes" => false } },
