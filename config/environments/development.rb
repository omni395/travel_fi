...
Rails.application.configure do
  ...
  # Evented file watcher — Propshaft не будет сканировать ФС на каждый запрос
  # Только для web-сервера (jobs процессу не нужен)
  config.file_watcher = ActiveSupport::EventedFileUpdateChecker if defined?(Rails::Server)
